...
// Source: github.com/int128/amefuriso/usecases (interfaces: IGetWeather,IGetImage,IPollWeathers,ICleanupImages,ISetup)
...
import (
	...
	usecases "github.com/int128/amefuriso/usecases"
	reflect "reflect"
)
...
// MockICleanupImages is a mock of ICleanupImages interface
type MockICleanupImages struct {
	ctrl     *gomock.Controller
	recorder *MockICleanupImagesMockRecorder
}

// MockICleanupImagesMockRecorder is the mock recorder for MockICleanupImages
type MockICleanupImagesMockRecorder struct {
	mock *MockICleanupImages
}

// NewMockICleanupImages creates a new mock instance
func NewMockICleanupImages(ctrl *gomock.Controller) *MockICleanupImages {
	mock := &MockICleanupImages{ctrl: ctrl}
	mock.recorder = &MockICleanupImagesMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockICleanupImages) EXPECT() *MockICleanupImagesMockRecorder {
	return m.recorder
}

// Do mocks base method
func (m *MockICleanupImages) Do(arg0 context.Context) error {
...
// Do indicates an expected call of Do
func (mr *MockICleanupImagesMockRecorder) Do(arg0 interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Do", reflect.TypeOf((*MockICleanupImages)(nil).Do), arg0)
}
