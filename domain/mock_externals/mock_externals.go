...
// Source: github.com/int128/amefurisobot/domain (interfaces: UserRepository,SubscriptionRepository,PNGRepository,WeatherService,NotificationService)
...
func (m *MockNotificationService) Send(arg0 context.Context, arg1 domain.Notification, arg2 domain.Message) error {
